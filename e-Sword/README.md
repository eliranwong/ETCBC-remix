NOTE: This collection is created for use with e-Sword X/HD/LT.  At the moment, PC version of e-Sword is not supported with this collection, due to limited functions of current PC e-Sword, though you may be able to run some of the files here with PC version (11+) of e-Sword.<br />
...
<b>[4] ETCBC.cmti (commentary module): </b>A commentary file on linguistic analysis (clause and phrase) and Hebrew word analysis (lexeme, morphology, etc.).  The text of BHS is available at the beginning of each article for easier reference.  It could be used independent of Hebrew bibles, e.g. use with English bibles.<br />
